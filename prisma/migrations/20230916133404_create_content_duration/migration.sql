/*
  ...
  - Added the required column `contets_duration` to the `contents` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_contents" ("contents_article", "contents_name", "contents_type", "contents_video_url", "id", "modulesId") SELECT "contents_article", "contents_name", "contents_type", "contents_video_url", "id", "modulesId" FROM "contents";
DROP TABLE "contents";
